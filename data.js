...
const data = [
  {
    name: 'Egbiri Ifegwu Egbiri',
    profileImage: './images/speakers/keynote-speaker.jpeg',
    bgImage: './images/draught.PNG',
    shortDesc: 'Keynote Speaker - Legal Counsel: International Monetary Fund (IMF)',
    longDescr:
        'Egbiri Egbiri is a Counsel with the Legal Department of the International Monetary Fund, headquartered in Washington DC, United States. Egbiri was ranked as one of the 100 Most Influential Young Nigerians in 2019 (an honoree in the Law and Governance category). He was an awardee of the ESQ Nigerian Legal Awards (2019) in the 40 Under 40 (Nigerian Rising Stars) Category.',
    link: 'https://www.linkedin.com/in/egbiri-egbiri/',
  },
  {
